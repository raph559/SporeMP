...
The SDK's bundled Detours 3 rejects the native four-byte getters with `ERROR_INVALID_BLOCK` (9). The build now uses Detours 4.0.1 source already present in the pinned injector checkout. It recognizes the verified padding after the native return instruction. No new dependency was fetched. All 27 hooks attach in the native run, including 17 additional exact code-prefix guards with six ASLR relocation entries. See [binding audit (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/binding-audit-02.json") and [native context audit](../../docs/m03-native-context-audit.md).
...
Exact native launch: [completion (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/award-01/completion.json"). Actual UI actions: [input log (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/award-01/input.jsonl"). Recorder argv/hash: [capture request (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/award-01/capture-01/request.json"). Analysis: [native summary (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/native-summary.json"), [trace structure (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/trace-analysis.json"), [capture processing (archived)](../../docs/public-evidence.md#historical-artifacts "Original path: evidence/2026-09-12-m03-awards/capture-extraction.json"), [acceptance](acceptance.json).
