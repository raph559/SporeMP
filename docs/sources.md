...
The SDK's Internal.h contains a GPL-3.0-or-later notice; EASTL and Detours have their own included notices. Keep upstream notices and review full dependency redistribution terms before release packaging. No project license assignment is made in this initial session. Do not redistribute EA binaries/assets or user saves; local dependency builds are not a licensed game redistribution.
